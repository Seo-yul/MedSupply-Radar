...
X-2가 `process_notices.py --all`로 공고 20건을 추출·매핑하고(§5) `run_risk_batch`를 재실행해 `data/medsupply.db`의 활성 공고 상향(`escalate_on_notice`)을 반영했다(README §LLM 기능 런북 ①~②단계). 이 절은 그 이후 상태에서 §2.2와 완전히 같은 스윕·라벨·파라미터로 다시 측정한 결과다 — 산출물은 신규 파일 `reports/analytics/detection_metrics_with_notices.json`이며, 기존 `detection_metrics.json`(공고 미반영 조건)은 한 바이트도 건드리지 않았다. **같은 탐지기·같은 문턱 — 달라진 것은 공고 매핑 데이터의 존재뿐이다**(`config_hash`도 `6ec9bf05`로 동일).<!-- check: reports/analytics/detection_metrics_with_notices.json:meta.extraction_state.extracted_notices = 20 -->
측정 조건의 기계 기록(신규 meta 키 `extraction_state`): 추출된 공고 20건, 매핑 행 47건(검토 필요 3건), 최신 run 기준 공고발 상향 28건이다.<!-- check: reports/analytics/detection_metrics_with_notices.json:meta.extraction_state.extracted_notices = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:meta.extraction_state.mapped_rows = 47 --><!-- check: reports/analytics/detection_metrics_with_notices.json:meta.extraction_state.needs_review_rows = 3 --><!-- check: reports/analytics/detection_metrics_with_notices.json:meta.extraction_state.active_escalations = 28 -->

| 문턱 | 표본 | 조건 | 감지율 | 오탐률 | 선행일수 중앙값 |
| --- | --- | --- | --- | --- | --- |
| 주의 이상 | raw(라벨 20) | 미반영 | 90.0%(18/20) | 45.19%(47/104) | 26.5일 |<!-- check: reports/analytics/detection_metrics.json:results.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics.json:results.detection_rate = 90.0% --><!-- check: reports/analytics/detection_metrics.json:results.counts.detected = 18 --><!-- check: reports/analytics/detection_metrics.json:results.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics.json:results.false_positive_rate = 45.19% --><!-- check: reports/analytics/detection_metrics.json:results.counts.false_positives = 47 --><!-- check: reports/analytics/detection_metrics.json:results.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics.json:results.lead_days.median = 26.5 -->
| 주의 이상 | raw(라벨 20) | 반영 | 90.0%(18/20) | 57.69%(60/104) | 31.5일 |<!-- check: reports/analytics/detection_metrics_with_notices.json:results.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.detection_rate = 90.0% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.counts.detected = 18 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.false_positive_rate = 57.69% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.counts.false_positives = 60 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.lead_days.median = 31.5 -->
| 주의 이상 | 지평 내(라벨 15) | 미반영 | 93.3%(14/15) | 45.19%(47/104) | 15.0일 |<!-- check: reports/analytics/detection_metrics.json:results.within_horizon.counts.labeled_in_horizon = 15 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_watch.detection_rate = 93.3% --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_watch.counts.detected = 14 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_watch.counts.labeled = 15 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_watch.false_positive_rate = 45.19% --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_watch.counts.false_positives = 47 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_watch.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_watch.lead_days.median = 15.0 -->
| 주의 이상 | 지평 내(라벨 15) | 반영 | 93.3%(14/15) | 57.69%(60/104) | 22.5일 |<!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.counts.labeled_in_horizon = 15 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_watch.detection_rate = 93.3% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_watch.counts.detected = 14 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_watch.counts.labeled = 15 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_watch.false_positive_rate = 57.69% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_watch.counts.false_positives = 60 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_watch.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_watch.lead_days.median = 22.5 -->
| 경고 이상 | raw(라벨 20) | 미반영 | 65.0%(13/20) | 3.85%(4/104) | 10일 |<!-- check: reports/analytics/detection_metrics.json:results.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_warning.detection_rate = 65.0% --><!-- check: reports/analytics/detection_metrics.json:results.threshold_warning.counts.detected = 13 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_warning.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_warning.false_positive_rate = 3.85% --><!-- check: reports/analytics/detection_metrics.json:results.threshold_warning.counts.false_positives = 4 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_warning.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_warning.lead_days.median = 10 -->
| 경고 이상 | raw(라벨 20) | 반영 | 80.0%(16/20) | 14.42%(15/104) | 14.0일 |<!-- check: reports/analytics/detection_metrics_with_notices.json:results.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_warning.detection_rate = 80.0% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_warning.counts.detected = 16 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_warning.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_warning.false_positive_rate = 14.42% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_warning.counts.false_positives = 15 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_warning.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_warning.lead_days.median = 14.0 -->
| 경고 이상 | 지평 내(라벨 15) | 미반영 | 66.7%(10/15) | 3.85%(4/104) | 9.0일 |<!-- check: reports/analytics/detection_metrics.json:results.within_horizon.counts.labeled_in_horizon = 15 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_warning.detection_rate = 66.7% --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_warning.counts.detected = 10 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_warning.counts.labeled = 15 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_warning.false_positive_rate = 3.85% --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_warning.counts.false_positives = 4 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_warning.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_warning.lead_days.median = 9.0 -->
| 경고 이상 | 지평 내(라벨 15) | 반영 | 86.7%(13/15) | 14.42%(15/104) | 10일 |<!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.counts.labeled_in_horizon = 15 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_warning.detection_rate = 86.7% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_warning.counts.detected = 13 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_warning.counts.labeled = 15 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_warning.false_positive_rate = 14.42% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_warning.counts.false_positives = 15 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_warning.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_warning.lead_days.median = 10 -->
| 위험 이상 | raw(라벨 20) | 미반영 | 45.0%(9/20) | 0.00%(0/104) | 7일 |<!-- check: reports/analytics/detection_metrics.json:results.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_danger.detection_rate = 45.0% --><!-- check: reports/analytics/detection_metrics.json:results.threshold_danger.counts.detected = 9 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_danger.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_danger.false_positive_rate = 0.00% --><!-- check: reports/analytics/detection_metrics.json:results.threshold_danger.counts.false_positives = 0 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_danger.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics.json:results.threshold_danger.lead_days.median = 7 -->
| 위험 이상 | raw(라벨 20) | 반영 | 45.0%(9/20) | 0.96%(1/104) | 7일 |<!-- check: reports/analytics/detection_metrics_with_notices.json:results.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_danger.detection_rate = 45.0% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_danger.counts.detected = 9 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_danger.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_danger.false_positive_rate = 0.96% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_danger.counts.false_positives = 1 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_danger.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_danger.lead_days.median = 7 -->
| 위험 이상 | 지평 내(라벨 15) | 미반영 | 53.3%(8/15) | 0.00%(0/104) | 7.0일 |<!-- check: reports/analytics/detection_metrics.json:results.within_horizon.counts.labeled_in_horizon = 15 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_danger.detection_rate = 53.3% --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_danger.counts.detected = 8 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_danger.counts.labeled = 15 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_danger.false_positive_rate = 0.00% --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_danger.counts.false_positives = 0 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_danger.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics.json:results.within_horizon.threshold_danger.lead_days.median = 7.0 -->
| 위험 이상 | 지평 내(라벨 15) | 반영 | 53.3%(8/15) | 0.96%(1/104) | 7.0일 |<!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.counts.labeled_in_horizon = 15 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_danger.detection_rate = 53.3% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_danger.counts.detected = 8 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_danger.counts.labeled = 15 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_danger.false_positive_rate = 0.96% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_danger.counts.false_positives = 1 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_danger.counts.normal = 104 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.within_horizon.threshold_danger.lead_days.median = 7.0 -->

부가 지표: 최고등급('위험') 정밀도는 100.0%에서 90.0%로, risk_type 일치율은 25.0%(5/20)에서 30.0%(6/20)로 바뀌었다.<!-- check: reports/analytics/detection_metrics.json:results.danger_precision = 100.0% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.danger_precision = 90.0% --><!-- check: reports/analytics/detection_metrics.json:results.risk_type_match.overall = 25.0% --><!-- check: reports/analytics/detection_metrics.json:results.risk_type_match.counts.matched = 5 --><!-- check: reports/analytics/detection_metrics.json:results.risk_type_match.counts.labeled = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.risk_type_match.overall = 30.0% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.risk_type_match.counts.matched = 6 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.risk_type_match.counts.labeled = 20 -->
선행일수 분포(주의 이상, raw)는 미반영 조건 최소 3일·평균 27.56일·최대 75일에서, 반영 조건 최소 5일·평균 33.89일·최대 75일로 바뀌었다.<!-- check: reports/analytics/detection_metrics.json:results.lead_days.min = 3 --><!-- check: reports/analytics/detection_metrics.json:results.lead_days.mean = 27.56 --><!-- check: reports/analytics/detection_metrics.json:results.lead_days.max = 75 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.lead_days.min = 5 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.lead_days.mean = 33.89 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.lead_days.max = 75 -->

**핵심 확인점 — ITM-0011은 이번에도 잡히지 않는다.** §6의 한계 목록이 '공고 경로로 보완 예정'이라고 적어 둔 품목이지만, 이번 20건의 실공고 원문 가운데 ITM-0011의 성분(덱시부프로펜)을 다루는 공고가 하나도 없어 `notice_item_map`에 이 품목의 매핑 행 자체가 없다 — 활성 공고에 의한 등급 상향 경로를 탈 수가 없으므로 반영 조건에서도 그대로 미감지다(`detected = false`).<!-- check: reports/analytics/detection_metrics_with_notices.json:meta.extraction_state.extracted_notices = 20 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.risk_type_match.items.ITM-0011.detected = false -->
감지된 라벨의 구성 자체도 미반영 조건과 완전히 같다 — 미감지 라벨은 반영 전후 동일하게 ITM-0011·ITM-0087 두 건이다.<!-- check: reports/analytics/detection_metrics_with_notices.json:results.risk_type_match.items.ITM-0087.detected = false -->

**오탐률·최고등급 정밀도가 나빠진 것은 판정이 나빠져서가 아니라 공고 데이터 반영의 효과다.** 오탐률이 45.19%에서 57.69%로 오른 이유는, 20건의 실공고가 커버하는 성분을 쓰는 정상(비라벨) 품목도 활성 공고만으로 '주의' 이상까지 상향되는 경우가 늘었기 때문이다 — 같은 문턱·같은 산식이고 새로 더해진 것은 입력 데이터(공고 매핑)뿐이다.<!-- check: reports/analytics/detection_metrics.json:results.false_positive_rate = 45.19% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.false_positive_rate = 57.69% --><!-- check: reports/analytics/detection_metrics_with_notices.json:meta.extraction_state.extracted_notices = 20 -->
최고등급 정밀도가 100.0%에서 90.0%로 낮아진 것도 같은 성질이다 — 정상 품목 ITM-0077 하나가 공고 상향만으로 '위험' 등급까지 도달한 것이 유일한 원인이다.<!-- check: reports/analytics/detection_metrics.json:results.danger_precision = 100.0% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.danger_precision = 90.0% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.threshold_danger.false_positive_items[0] = "ITM-0077" -->
반대로 선행일수 중앙값 상승(26.5일→31.5일)과 risk_type 일치율 상승(25.0%→30.0%)도 같은 이유로 '탐지 성능 개선'이 아니다 — 활성 공고가 재고 소진 신호보다 먼저 등급을 올려 first_alert가 당겨지고, 공고 매핑이 risk_type을 'general'에서 더 구체적인 값으로 바꾸는 품목이 늘어난 결과일 뿐, 탐지기·문턱·파라미터는 미반영 조건과 조금도 다르지 않다.<!-- check: reports/analytics/detection_metrics.json:results.lead_days.median = 26.5 --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.lead_days.median = 31.5 --><!-- check: reports/analytics/detection_metrics.json:results.risk_type_match.overall = 25.0% --><!-- check: reports/analytics/detection_metrics_with_notices.json:results.risk_type_match.overall = 30.0% -->
...
API 키가 없던 구간이 있어 이 절의 수치는 아직 전부 채워지지 않았다. 공고 추출 정확도는
Anthropic 키로 이미 실측했고(X-2, README §LLM 기능 런북 ①단계), judge 채점·인간
교차검토는 교차 채점에 필요한 **OpenAI 키가 아직 없어** 여전히 **실측 전**이다(§1.4의
"생성·채점 공급자를 다르게 강제" 설계상 Anthropic 키만으로는 judge를 실행할 수 없다).
수치 자리에 추정치를 넣지 않는다.

| 항목 | 준비된 장치 | 수치 |
| --- | --- | --- |
| 공고 추출 정확도 | 골드 라벨(`data/notices/gold/gold_labels_v1.json` — 공고 전건, 추출 로직과 독립 작성) + 필드별 일치율·`needs_review` 재현/정밀을 산출하는 `scripts/measure_extraction.py` | **100.0%**(macro_accuracy) |<!-- check: reports/llm/extraction_accuracy.json:macro_accuracy = 100.0% -->
...
공고 추출 정확도 실측 결과(`reports/llm/extraction_accuracy.json`, **관용(lenient) 대조**): 골드 라벨 20건 전부 추출됐고(미추출 0건) macro_accuracy 100.0%다(필드별 세부 수치는 원본 참조).<!-- check: reports/llm/extraction_accuracy.json:extracted_count = 20 --><!-- check: reports/llm/extraction_accuracy.json:unextracted_count = 0 --><!-- check: reports/llm/extraction_accuracy.json:macro_accuracy = 100.0% -->
**이 100.0%는 사전 등록된 조건 위에 서 있다** — N-001·N-014·N-017 세 건은 골드 notes에 "재개일자/정상화 예상일자 이중 표기"가 있어(S-24 리뷰 권고, 사전 등록 규칙) expected_restart_date를 두 값 중 어느 쪽이든 인정해 일치 처리한 결과다(`scripts/measure_extraction.py`의 `ALTERNATE_EXPECTED_RESTART_DATES` 허용 목록 — notice_id별 지정된 대안 값만 정확히 인정하고 임의의 값까지 허용하지는 않는다).<!-- check: reports/llm/extraction_accuracy.json:macro_accuracy = 100.0% -->
그 인정을 걷어낸 **strict 대조**(같은 파일 `strict` 블록, 양가 목록 미적용 — Task X-3 체인 리뷰 F1)로 다시 보면 expected_restart_date 정확도가 85.0%(17/20)로, macro_accuracy가 97.0%로 내려간다.<!-- check: reports/llm/extraction_accuracy.json:strict.expected_restart_date.accuracy = 85.0% --><!-- check: reports/llm/extraction_accuracy.json:strict.expected_restart_date.matched = 17 --><!-- check: reports/llm/extraction_accuracy.json:strict.expected_restart_date.total = 20 --><!-- check: reports/llm/extraction_accuracy.json:strict.macro_accuracy = 97.0% -->
needs_review 양성 여부는 골드가 직접 라벨링한 속성이 아니라 "스코어링 대상 필드 중 하나라도 불일치"에서 **파생되는 값**이다 — 관용 대조에서는 이 세 건도 대안값이 정답 인정되어 전 필드 일치라 파생 양성이 없었지만(tp=0·fn=0·fp=0·tn=20), strict 대조에서는 이 세 건 모두 파생 양성(불일치)으로 바뀌고, 셋 다 실제 추출 status가 '자동확정'(비양성 예측)이라 recall이 0.0%(tp=0, fn=3)로 떨어진다(precision은 fp=0이라 정의상 n/a) — needs_review 게이트가 이 규약 차이 세 건을 전부 자동확정으로 통과시켰다는 뜻이다.<!-- check: reports/llm/extraction_accuracy.json:needs_review.tp = 0 --><!-- check: reports/llm/extraction_accuracy.json:needs_review.fn = 0 --><!-- check: reports/llm/extraction_accuracy.json:needs_review.fp = 0 --><!-- check: reports/llm/extraction_accuracy.json:needs_review.tn = 20 --><!-- check: reports/llm/extraction_accuracy.json:strict.needs_review.recall = 0.0% --><!-- check: reports/llm/extraction_accuracy.json:strict.needs_review.tp = 0 --><!-- check: reports/llm/extraction_accuracy.json:strict.needs_review.fn = 3 --><!-- check: reports/llm/extraction_accuracy.json:strict.needs_review.fp = 0 -->
골드 라벨이 이번 실공고 전건과 정확히 대응하는 소규모 셋(20건)이라는 점도 감안해야 한다.<!-- check: reports/llm/extraction_accuracy.json:extracted_count = 20 -->

**AI 설명의 사후 대조 신호(hallucination_flags)도 judge 없이 이미 실측돼 있다.** `warm_cache.py`가 생성한 원인 설명 71건(risk_explain, X-2) 중 44건(62.0%)에 `verify_explanation_grounding`의 사후 대조 플래그가 1개 이상 붙어 있다 <!-- check-skip: data/llm_cache.db(llm_explanations 71건의 payload_json.hallucination_flags를 직접 순회 집계 — .gitignore 대상이라 committed reports/ JSON에 없다) -->. 이 플래그는 `medsupply/llm/grounding.py` 자체 docstring이 명시하는 대로 role-blind 부분 신호일 뿐 무결 보증이 아니다 — 발생률이 높다는 사실 자체만 정직하게 기록한다(원인 진단·프롬프트 수정은 이번 범위 밖).
워크벤치 화면에도 이 값이 숨김 없이 노출된다 — 플래그가 있는 품목은 "사후 대조 경고 N건" 배지가 뜨고 플래그 문자열 앞 두 개까지 본문에 그대로 인용된다(`medsupply/views/review.py` `_explanation_badge_html`). 위 추출 정확도 절이 유리한 수치를 100.0%로 먼저 밝히고 strict 대조로 그 조건을 마저 공개했듯, 이 절도 불리한 수치를 같은 방식으로 숨기지 않는다.<!-- check: reports/llm/extraction_accuracy.json:macro_accuracy = 100.0% -->
...
§2의 감지 수치가 "공고 반영 조건"으로 재측정되기 때문이다 — 이 순서는 이미 한 번
실행됐고(X-2), 그 재측정 결과는 §2.5에 있다.
...
4. **라벨 표본이 작다.** 블라인드는 시드마다 유형별로 라벨 하나씩뿐이라, 품목 하나의
   ...
   일반화할 수 없다.
5. **ITM-0011 — 공고 경로로도 미감지(예측 반증).** 표준 스냅샷에서 감지되지 않은 라벨 하나는 봉쇄된
   발주의 예정일이 스윕 종료일 밖이라, 스윕 내내 "아직 예정일이 안 온 정상 pending"으로 보인
   사례다. 파라미터로는 닿지 않는다. 이 문서는 한때 "공고 경로로 보완 예정"이라고 적어 뒀지만,
   **그 예측은 실측으로 반증됐다** — 이번 20건 실공고 가운데 이 품목의 성분(덱시부프로펜)을 다루는 공고가 하나도 없어 공고 경로로도 미감지다(§2.5에서 확인).<!-- check: reports/analytics/detection_metrics_with_notices.json:meta.extraction_state.extracted_notices = 20 -->
   보완하려면 해당 성분의 공고 확보, 또는 발주 이상 신호 쪽 감지 지평의 확장이 필요하다.
...
8. **§2.1~§2.4의 감지·오탐 수치는 공고 미반영 조건 기준이다.** 공고는 적재만 됐고 추출·매핑되지
   않아 활성 공고에 의한 등급 상향이 없는 상태에서 측정한 값이며, `detection_metrics.json` 등은
   그 조건대로 동결돼 있다. 공고 반영 조건으로 재측정한 값은 §2.5에 별도 파일
   (`detection_metrics_with_notices.json`)로 병기돼 있다 — 두 조건을 같은 표에 섞지 않는다.
...
12. **needs_review 게이트가 규약 차이 세 건을 전부 자동확정으로 통과시켰다.** 관용 대조에서는 골드·실제 추출 모두 파생 양성 사례가 없어(tp=0·fn=0·fp=0·tn=20) recall·precision이 정의상 계산 불가(n/a)였지만, 이는 N-001·N-014·N-017의 대안값 인정 때문에 만들어진 결과다(§5). 그 인정을 걷어낸 strict 대조에서는 이 세 건이 전부 파생 양성(불일치)으로 바뀌는데, 셋 다 실제로는 '자동확정'으로 통과해 recall이 0.0%(tp=0, fn=3)다 — '이번 데이터로는 검증 못 했다'가 아니라 '검증했더니 이 세 건을 전부 놓쳤다'로 정정한다.<!-- check: reports/llm/extraction_accuracy.json:needs_review.tp = 0 --><!-- check: reports/llm/extraction_accuracy.json:needs_review.fn = 0 --><!-- check: reports/llm/extraction_accuracy.json:needs_review.fp = 0 --><!-- check: reports/llm/extraction_accuracy.json:needs_review.tn = 20 --><!-- check: reports/llm/extraction_accuracy.json:strict.needs_review.recall = 0.0% --><!-- check: reports/llm/extraction_accuracy.json:strict.needs_review.tp = 0 --><!-- check: reports/llm/extraction_accuracy.json:strict.needs_review.fn = 3 -->
